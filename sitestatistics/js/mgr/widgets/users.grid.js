...
Ext.extend(siteStatistics.grid.Users, MODx.grid.Grid, {
	...
	getFields: function (config) {
		return ['user_key', 'uid', 'fullname','date', 'rid', 'pagetitle','context', 'actions', 'message_showed', 'ip', 'user_agent', 'referer'];
	},
	...
	getColumns: function (config) {
		return [this.sm,{
			...
			header: _('sitestatistics_user_id'),
			dataIndex: 'uid',
			sortable: true,
			width: 60
		}, {
			header: _('sitestatistics_user_key'),
			dataIndex: 'user_key',
			sortable: true,
			width: 180
		}, {
