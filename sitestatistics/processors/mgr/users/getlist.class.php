...
class siteStatisticsUsersGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        ...
        $c->select('UserStatistics.user_key, UserStatistics.uid, UserStatistics.rid, UserStatistics.context, Profile.fullname, Resource.pagetitle');
    ...
    public function prepareRow(xPDOObject $object)
    {
        ...
        $user['uid'] = !empty($user['uid']) ? (int)$user['uid'] : '';
        $user['pagetitle'] = !empty($user['pagetitle']) ? $user['pagetitle'] : '';
